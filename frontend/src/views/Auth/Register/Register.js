...
const validationSchema = Yup.object().shape({
  ...
  last_name: Yup.string().trim().max(64, 'Name must be 64 characters or less').required('Please enter your last name'),
  email: Yup.string().trim().email('Invalid email').required('Please enter your email'),
  password: Yup.string().trim().min(6).required('Please enter a password'),
